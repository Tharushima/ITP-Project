...
<body>
    ...
    <h5><b>
            <center>Urgent Maintenance Request Update Form</center>
        </b>
    </h5>
        ...
        <form action="php/update2.php" method="post">
            ...
            <h4 class="display-4 text-center">Update<h4>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="mainid" value="<?= $row['mainid'] ?>" id="name">
                    </div>


                    <div class="form-group">
                        <label for="client">client ID</label>
                        <input type="text" class="form-control" id="clientid" name="clientid" value="<?= $row['clientid']  ?>">
                    </div>

                    <div class="form-group">
                        <label for="lastmain">Last Maintenance Day</label>
                        <input type="text" class="form-control" id="lastmain" name="lastmain" value="<?= $row['lastmain']  ?>">
                    </div>
                    <div class="form-group">
                        <label for="Reason">Reason</label>
                        <input type="tel" class="form-control" id="reason" name="reason" value="<?= $row['reason']  ?>">
                    </div>
