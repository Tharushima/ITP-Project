        ...
        <div class="box">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th scope="col">ID</th>
                        <th scope="col">Maintance ID</th>
                        <th scope="col">Client ID</th>
                        <th scope="col">Last Maintance Day</th>
                ...
                $sql = "SELECT * FROM urgentmaintance WHERE mainid=$search";
                ...
                ?>
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $rows['lastmain']; ?></td>
                            <td><?php echo $rows['reason']; ?></td>
                            <td><a href="update2.php?id=<?= $rows['id'] ?>" class="btn btn-success">Update</a></td>
                            <td><a href="delete2.php?id=<?= $rows['id'] ?>" class="btn btn-danger">Delete</a>
                            </td>
            ...
            <div class="link-right">
                <a href="read2.php" class="btn btn-primary">back</a>
            </div>
        </div>
    </div>
