...
<body>
  ...
  <br>
  <h5><b>
      <center>Regular Maintenance Request Form</center>
    </b>
  </h5>
  ...
  <div class="container">
    <form action="php/create.php" method="post">
      ...
      <div class="form-group">
        ...
        <input type="date" class="form-control" id="nextmain" name="nextmain" value="<?php if (isset($_GET['nextmain']))
                                                                                        echo ($_GET['nextmain']); ?>" required placeholder="Enter Next Maintenance Day">
      </div>
