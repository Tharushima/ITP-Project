    ...
    <form action="php/update.php" method="post">
      ...
      <h4 class="display-4 text-center">Update<h4>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="delivery" name="lastmain" value="<?= $row['lastmain']  ?>">
          </div>
          <div class="form-group">
            <label for="phone">Next Maintenance Day</label>
            <input type="text" class="form-control" id="phone" name="nextmain" value="<?= $row['nextmain']  ?>">
          </div>
