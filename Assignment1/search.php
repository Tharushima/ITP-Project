...
<link rel="stylesheet" type="text/css" href="styles/header.css">
    <div class="header">
        ...
        <div class="header-right">
            ...
            <a href="#contact">Maintenance Request</a>
                                ...
                                <table class="table table-striped">
                                        <thead>
                                                <tr>
                                                        ...
                                                        <th scope="col">Next Mainynce Day</th>
                                        ...
                                        $sql = "SELECT * FROM maintence WHERE mainid=$search";
                                        ...
                                        ?>
                                                <tbody>
                                                        <tr>
                                                                ...
                                                                <td><?php echo $rows['nextmain']; ?></td>
                                                                <td><a href="update.php?id=<?= $rows['id'] ?>" class="btn btn-success">Update</a></td>
                                                                <td><a href="delete.php?id=<?= $rows['id'] ?>" class="btn btn-danger">Delete</a>
                                                                </td>
