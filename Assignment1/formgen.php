...
<body>
    ...
    <div class="backimg">
        ...
        <form>
            <h5><b>
                    <center>Genarate Request Form</center>
                </b>
            </h5>
            <br>
            <br>
            <div class="container">
                <div class="center">
                    <a href="index2.php" class="btn btn-primary"> Urgent Maintenance Request</a>

                    <a href="index.php" class="btn btn-primary"> Regular Maintenance Request</a>
