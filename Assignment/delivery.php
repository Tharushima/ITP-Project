...
if(isset($_POST['search']))
{
    ...
    // connect to mysql
    $connect = mysqli_connect("localhost", "root", "","control_print_ltd");
    
    // mysql search query
    $query = "SELECT `clientid`, `addresses`, `delitem`, 'phone', 'delichar' FROM `delivery` WHERE `id` = $id LIMIT 1";
